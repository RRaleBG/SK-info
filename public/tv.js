        ...
        <div class="weather-cards" onclick="getIpLocation()" style="cursor: pointer;">
            ...
            <div class="bottom-info">
                <div class="info-item">
                    ...
                    <span class="info-value" style="color: #4fc3f7;">${(hum)}%</span>
                </div>
                <div class="info-item">
                    <span class="info-label">💨 Vetar</span>
                    <span class="info-value" style="color: #ffce54;">${(wind * 3.6).toFixed(1)} km/h</span>
                </div>
                <div class="info-item">
                    <span class="info-label">🌡️ Subjektivni</span>                           
                    <span class="info-value" style="color: ${feelColor};">${feel}&deg;</span>
                </div>
            </div>
